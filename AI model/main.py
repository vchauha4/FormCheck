...
vidPath= 'wrong-curl\\wrong[9].mp4'
...
vidpath1=['wrong-curl\\wrong[0].mp4', 'wrong-curl\\wrong[10].mp4', 'wrong-curl\\wrong[1].mp4', 'wrong-curl\\wrong[2].mp4', 'wrong-curl\\wrong[3].mp4', 'wrong-curl\\wrong[4].mp4', 'wrong-curl\\wrong[5].mp4', 'wrong-curl\\wrong[6].mp4', 'wrong-curl\\wrong[7].mp4', 'wrong-curl\\wrong[8].mp4']
# print(vidpath1[84])
